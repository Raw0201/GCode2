...
################################################################################
## Form generated from reading UI file 'threadQmPKFM.ui'
##
...
class Ui_frm_thread(object):
    def setupUi(self, frm_thread):
        if not frm_thread.objectName():
            frm_thread.setObjectName(u"frm_thread")
        frm_thread.resize(210, 380)
        sizePolicy = QSizePolicy(QSizePolicy.Expanding, QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(frm_thread.sizePolicy().hasHeightForWidth())
        frm_thread.setSizePolicy(sizePolicy)
        frm_thread.setMinimumSize(QSize(210, 380))
        frm_thread.setMaximumSize(QSize(210, 380))
        icon = QIcon()
        icon.addFile(u":/icons/gear.png", QSize(), QIcon.Normal, QIcon.Off)
        frm_thread.setWindowIcon(icon)
        frm_thread.setStyleSheet(u"/* ---------------------------------------------------------------------------\n"
"\n"
...
"  padding: 0px;\n"
"}")
        self.centralwidget = QWidget(frm_thread)
        ...
        self.tbx_zin.setGeometry(QRect(10, 30, 170, 26))
        ...
        self.lbl_zin.setGeometry(QRect(20, 10, 101, 26))
        ...
        self.lbl_thd.setGeometry(QRect(20, 110, 131, 26))
        self.lbl_znd = QLabel(self.frame)
        self.lbl_znd.setObjectName(u"lbl_znd")
        self.lbl_znd.setEnabled(True)
        self.lbl_znd.setGeometry(QRect(20, 60, 91, 26))
        self.tbx_znd = QLineEdit(self.frame)
        self.tbx_znd.setObjectName(u"tbx_znd")
        self.tbx_znd.setGeometry(QRect(10, 80, 170, 26))
        self.tbx_znd.setMinimumSize(QSize(170, 0))
        self.tbx_znd.setMaximumSize(QSize(170, 16777215))
        self.tbx_znd.setAlignment(Qt.AlignCenter)
        self.cbx_thd = QComboBox(self.frame)
        self.cbx_thd.setObjectName(u"cbx_thd")
        self.cbx_thd.setGeometry(QRect(10, 130, 170, 26))
        ...
        self.cbx_pos.setGeometry(QRect(10, 230, 170, 26))
        ...
        self.lbl_pos.setGeometry(QRect(20, 210, 139, 26))
        self.cbx_typ = QComboBox(self.frame)
        self.cbx_typ.setObjectName(u"cbx_typ")
        self.cbx_typ.setGeometry(QRect(10, 180, 170, 26))
        ...
        self.lbl_typ.setGeometry(QRect(20, 160, 81, 26))
        self.cbx_rgh = QComboBox(self.frame)
        self.cbx_rgh.setObjectName(u"cbx_rgh")
        self.cbx_rgh.setGeometry(QRect(10, 280, 170, 26))
        self.cbx_rgh.setMinimumSize(QSize(170, 26))
        self.cbx_rgh.setMaximumSize(QSize(170, 16777215))
        self.lbl_rgh = QLabel(self.frame)
        self.lbl_rgh.setObjectName(u"lbl_rgh")
        self.lbl_rgh.setEnabled(True)
        self.lbl_rgh.setGeometry(QRect(20, 260, 94, 26))
        self.tbx_zin.raise_()
        self.lbl_zin.raise_()
        ...
        frm_thread.setCentralWidget(self.centralwidget)
#if QT_CONFIG(shortcut)
        self.lbl_zin.setBuddy(self.lbl_zin)
        self.lbl_thd.setBuddy(self.lbl_thd)
        self.lbl_znd.setBuddy(self.lbl_znd)
        self.lbl_pos.setBuddy(self.lbl_thd)
        self.lbl_typ.setBuddy(self.lbl_thd)
        self.lbl_rgh.setBuddy(self.lbl_thd)
#endif // QT_CONFIG(shortcut)
        QWidget.setTabOrder(self.tbx_zin, self.tbx_znd)
        QWidget.setTabOrder(self.tbx_znd, self.cbx_thd)
        QWidget.setTabOrder(self.cbx_thd, self.cbx_typ)
        QWidget.setTabOrder(self.cbx_typ, self.cbx_pos)
        QWidget.setTabOrder(self.cbx_pos, self.cbx_rgh)
        QWidget.setTabOrder(self.cbx_rgh, self.btn_save)
        QWidget.setTabOrder(self.btn_save, self.btn_help)

        self.retranslateUi(frm_thread)

        QMetaObject.connectSlotsByName(frm_thread)
    # setupUi

    def retranslateUi(self, frm_thread):
        frm_thread.setWindowTitle(QCoreApplication.translate("frm_thread", u"GCode Editor", None))
#if QT_CONFIG(tooltip)
        self.tbx_zin.setToolTip(QCoreApplication.translate("frm_thread", u"Digite la posici\u00f3n inicial de la rosca en el eje Z", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
        self.tbx_zin.setStatusTip("")
#endif // QT_CONFIG(statustip)
        self.tbx_zin.setPlaceholderText("")
        self.lbl_zin.setText(QCoreApplication.translate("frm_thread", u"Posici\u00f3n inicial Z", None))
#if QT_CONFIG(tooltip)
        self.btn_save.setToolTip(QCoreApplication.translate("frm_thread", u"Agregar los datos al programa CNC", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
        self.btn_save.setStatusTip("")
#endif // QT_CONFIG(statustip)
        self.btn_save.setText(QCoreApplication.translate("frm_thread", u"Agregar", None))
#if QT_CONFIG(shortcut)
        self.btn_save.setShortcut(QCoreApplication.translate("frm_thread", u"Ctrl+S", None))
#endif // QT_CONFIG(shortcut)
        self.lbl_thd.setText(QCoreApplication.translate("frm_thread", u"Dimensi\u00f3n de la rosca", None))
        self.lbl_znd.setText(QCoreApplication.translate("frm_thread", u"Posici\u00f3n final Z", None))
#if QT_CONFIG(tooltip)
        self.tbx_znd.setToolTip(QCoreApplication.translate("frm_thread", u"Digite la posici\u00f3n final de la rosca en el eje Z", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
        self.tbx_znd.setStatusTip("")
#endif // QT_CONFIG(statustip)
        self.tbx_znd.setPlaceholderText("")
#if QT_CONFIG(tooltip)
        self.cbx_thd.setToolTip(QCoreApplication.translate("frm_thread", u"Seleccione la dimensi\u00f3n de la rosca", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.cbx_pos.setToolTip(QCoreApplication.translate("frm_thread", u"Seleccione la posici\u00f3n de la herramienta", None))
#endif // QT_CONFIG(tooltip)
        self.lbl_pos.setText(QCoreApplication.translate("frm_thread", u"Posici\u00f3n de herramienta", None))
#if QT_CONFIG(tooltip)
        self.cbx_typ.setToolTip(QCoreApplication.translate("frm_thread", u"Seleccione si la rosca es de tipo externa o interna", None))
#endif // QT_CONFIG(tooltip)
        self.lbl_typ.setText(QCoreApplication.translate("frm_thread", u"Tipo de rosca", None))
#if QT_CONFIG(tooltip)
        self.cbx_rgh.setToolTip(QCoreApplication.translate("frm_thread", u"Seleccione si se requiere desahogo de la rosca (corte inicial)", None))
#endif // QT_CONFIG(tooltip)
        self.lbl_rgh.setText(QCoreApplication.translate("frm_thread", u"Desahogo rosca", None))
        self.btn_help.setText("")
#if QT_CONFIG(shortcut)
        self.btn_help.setShortcut(QCoreApplication.translate("frm_thread", u"F1", None))
#endif // QT_CONFIG(shortcut)
    # retranslateUi
