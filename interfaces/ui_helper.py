...
"  padding: 0px;\n"
"}")
        self.centralwidget = QWidget(frm_helper)
        ...
        frm_helper.setCentralWidget(self.centralwidget)

        self.retranslateUi(frm_helper)

        QMetaObject.connectSlotsByName(frm_helper)
    # setupUi

    def retranslateUi(self, frm_helper):
        frm_helper.setWindowTitle(QCoreApplication.translate("frm_helper", u"Ventana de ayuda", None))
