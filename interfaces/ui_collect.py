...
class Ui_frm_collect(object):
    def setupUi(self, frm_collect):
        if not frm_collect.objectName():
            frm_collect.setObjectName(u"frm_collect")
        frm_collect.resize(210, 130)
        sizePolicy = QSizePolicy(QSizePolicy.Expanding, QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(frm_collect.sizePolicy().hasHeightForWidth())
        frm_collect.setSizePolicy(sizePolicy)
        frm_collect.setMinimumSize(QSize(210, 130))
        frm_collect.setMaximumSize(QSize(210, 130))
        icon = QIcon()
        icon.addFile(u":/icons/gear.png", QSize(), QIcon.Normal, QIcon.Off)
        frm_collect.setWindowIcon(icon)
        frm_collect.setStyleSheet(u"/* ---------------------------------------------------------------------------\n"
"\n"
...
"  padding: 0px;\n"
"}")
        self.centralwidget = QWidget(frm_collect)
        self.centralwidget.setObjectName(u"centralwidget")
        self.frame = QFrame(self.centralwidget)
        self.frame.setObjectName(u"frame")
        self.frame.setGeometry(QRect(10, 10, 190, 110))
        sizePolicy1 = QSizePolicy(QSizePolicy.Fixed, QSizePolicy.Fixed)
        sizePolicy1.setHorizontalStretch(0)
        sizePolicy1.setVerticalStretch(0)
        sizePolicy1.setHeightForWidth(self.frame.sizePolicy().hasHeightForWidth())
        self.frame.setSizePolicy(sizePolicy1)
        self.frame.setMinimumSize(QSize(190, 110))
        self.frame.setMaximumSize(QSize(190, 110))
        ...
        self.cbx_clt.setMinimumSize(QSize(170, 26))
        self.cbx_clt.setMaximumSize(QSize(170, 16777215))
        self.btn_save = QPushButton(self.frame)
        self.btn_save.setObjectName(u"btn_save")
        self.btn_save.setGeometry(QRect(10, 80, 171, 24))
        ...
        frm_collect.setCentralWidget(self.centralwidget)
#if QT_CONFIG(shortcut)
        self.lbl_clt.setBuddy(self.lbl_clt)
#endif // QT_CONFIG(shortcut)
        QWidget.setTabOrder(self.cbx_clt, self.btn_save)
        QWidget.setTabOrder(self.btn_save, self.btn_help)

        self.retranslateUi(frm_collect)

        QMetaObject.connectSlotsByName(frm_collect)
    # setupUi

    def retranslateUi(self, frm_collect):
        frm_collect.setWindowTitle(QCoreApplication.translate("frm_collect", u"GCode Editor", None))
        self.lbl_clt.setText(QCoreApplication.translate("frm_collect", u"Recolecci\u00f3n de pieza", None))
#if QT_CONFIG(tooltip)
        self.cbx_clt.setToolTip(QCoreApplication.translate("frm_collect", u"Seleccione el modo de recolecci\u00f3n de pieza", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.btn_save.setToolTip(QCoreApplication.translate("frm_collect", u"Agregar los datos al programa CNC", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
        self.btn_save.setStatusTip("")
#endif // QT_CONFIG(statustip)
        self.btn_save.setText(QCoreApplication.translate("frm_collect", u"Agregar", None))
#if QT_CONFIG(shortcut)
        self.btn_save.setShortcut(QCoreApplication.translate("frm_collect", u"Ctrl+S", None))
#endif // QT_CONFIG(shortcut)
        self.btn_help.setText("")
#if QT_CONFIG(shortcut)
        self.btn_help.setShortcut(QCoreApplication.translate("frm_collect", u"F1", None))
#endif // QT_CONFIG(shortcut)
    # retranslateUi
