...
################################################################################
## Form generated from reading UI file 'cutoffVikeem.ui'
##
...
class Ui_frm_cutoff(object):
    def setupUi(self, frm_cutoff):
        if not frm_cutoff.objectName():
            frm_cutoff.setObjectName(u"frm_cutoff")
        frm_cutoff.resize(210, 180)
        sizePolicy = QSizePolicy(QSizePolicy.Expanding, QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(frm_cutoff.sizePolicy().hasHeightForWidth())
        frm_cutoff.setSizePolicy(sizePolicy)
        frm_cutoff.setMinimumSize(QSize(210, 180))
        frm_cutoff.setMaximumSize(QSize(210, 180))
        icon = QIcon()
        icon.addFile(u":/icons/gear.png", QSize(), QIcon.Normal, QIcon.Off)
        frm_cutoff.setWindowIcon(icon)
        frm_cutoff.setStyleSheet(u"/* ---------------------------------------------------------------------------\n"
"\n"
...
"  padding: 0px;\n"
"}")
        self.centralwidget = QWidget(frm_cutoff)
        ...
        self.tbx_dia.setGeometry(QRect(10, 30, 170, 26))
        ...
        self.tbx_cfr.setMinimumSize(QSize(170, 0))
        self.tbx_cfr.setMaximumSize(QSize(170, 16777215))
        self.tbx_cfr.setAlignment(Qt.AlignCenter)
        self.tbx_dia.raise_()
        self.lbl_dia.raise_()
        ...
        frm_cutoff.setCentralWidget(self.centralwidget)
#if QT_CONFIG(shortcut)
        self.lbl_dia.setBuddy(self.lbl_dia)
        self.lbl_cfr.setBuddy(self.lbl_cfr)
#endif // QT_CONFIG(shortcut)
        QWidget.setTabOrder(self.tbx_dia, self.tbx_cfr)
        QWidget.setTabOrder(self.tbx_cfr, self.btn_save)
        QWidget.setTabOrder(self.btn_save, self.btn_help)

        self.retranslateUi(frm_cutoff)

        QMetaObject.connectSlotsByName(frm_cutoff)
    # setupUi

    def retranslateUi(self, frm_cutoff):
        frm_cutoff.setWindowTitle(QCoreApplication.translate("frm_cutoff", u"GCode Editor", None))
#if QT_CONFIG(tooltip)
        self.tbx_dia.setToolTip(QCoreApplication.translate("frm_cutoff", u"Digite la dimensi\u00f3n del di\u00e1metro a tronzar", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
        self.tbx_dia.setStatusTip("")
#endif // QT_CONFIG(statustip)
        self.tbx_dia.setPlaceholderText("")
        self.lbl_dia.setText(QCoreApplication.translate("frm_cutoff", u"Di\u00e1metro a tronzar", None))
#if QT_CONFIG(tooltip)
        self.btn_save.setToolTip(QCoreApplication.translate("frm_cutoff", u"Agregar los datos al programa CNC", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
        self.btn_save.setStatusTip("")
#endif // QT_CONFIG(statustip)
        self.btn_save.setText(QCoreApplication.translate("frm_cutoff", u"Agregar", None))
#if QT_CONFIG(shortcut)
        self.btn_save.setShortcut(QCoreApplication.translate("frm_cutoff", u"Ctrl+S", None))
#endif // QT_CONFIG(shortcut)
        self.lbl_cfr.setText(QCoreApplication.translate("frm_cutoff", u"Dimensi\u00f3n del bisel", None))
#if QT_CONFIG(tooltip)
        self.tbx_cfr.setToolTip(QCoreApplication.translate("frm_cutoff", u"Digite la dimensi\u00f3n del bisel", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
        self.tbx_cfr.setStatusTip("")
#endif // QT_CONFIG(statustip)
        self.tbx_cfr.setPlaceholderText("")
        self.btn_help.setText("")
#if QT_CONFIG(shortcut)
        self.btn_help.setShortcut(QCoreApplication.translate("frm_cutoff", u"F1", None))
#endif // QT_CONFIG(shortcut)
    # retranslateUi
