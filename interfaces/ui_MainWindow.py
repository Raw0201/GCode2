...
################################################################################
## Form generated from reading UI file 'MainWindowJsoQFY.ui'
##
...
"}")
        ...
        sizePolicy4.setHeightForWidth(self.btn_spindle_index.sizePolicy().hasHeightForWidth())
        self.btn_spindle_index.setSizePolicy(sizePolicy4)
        ...
        sizePolicy4.setHeightForWidth(self.btn_misc.sizePolicy().hasHeightForWidth())
        self.btn_misc.setSizePolicy(sizePolicy4)
        ...
        sizePolicy4.setHeightForWidth(self.btn_tool_call.sizePolicy().hasHeightForWidth())
        self.btn_tool_call.setSizePolicy(sizePolicy4)
        ...
        sizePolicy4.setHeightForWidth(self.btn_tool_close.sizePolicy().hasHeightForWidth())
        self.btn_tool_close.setSizePolicy(sizePolicy4)
        ...
        sizePolicy4.setHeightForWidth(self.btn_comment.sizePolicy().hasHeightForWidth())
        self.btn_comment.setSizePolicy(sizePolicy4)
        ...
        sizePolicy4.setHeightForWidth(self.btn_header.sizePolicy().hasHeightForWidth())
        self.btn_header.setSizePolicy(sizePolicy4)
        ...
        sizePolicy4.setHeightForWidth(self.btn_end.sizePolicy().hasHeightForWidth())
        self.btn_end.setSizePolicy(sizePolicy4)
        ...
        sizePolicy4.setHeightForWidth(self.btn_collect.sizePolicy().hasHeightForWidth())
        self.btn_collect.setSizePolicy(sizePolicy4)
        ...
        self.gridLayout_5.addWidget(self.btn_thread, 3, 0, 1, 1)

        self.btn_cutoff = QPushButton(self.groupBox_turning)
        self.btn_cutoff.setObjectName(u"btn_cutoff")

        self.gridLayout_5.addWidget(self.btn_cutoff, 4, 0, 1, 1)

        self.btn_lineal_turn = QPushButton(self.groupBox_turning)
        self.btn_lineal_turn.setObjectName(u"btn_lineal_turn")
        sizePolicy4.setHeightForWidth(self.btn_lineal_turn.sizePolicy().hasHeightForWidth())
        self.btn_lineal_turn.setSizePolicy(sizePolicy4)
        self.btn_lineal_turn.setMinimumSize(QSize(28, 0))
        self.btn_lineal_turn.setMaximumSize(QSize(120, 16777215))

        self.gridLayout_5.addWidget(self.btn_lineal_turn, 1, 0, 1, 1)

        self.btn_radial_turn = QPushButton(self.groupBox_turning)
        self.btn_radial_turn.setObjectName(u"btn_radial_turn")

        self.gridLayout_5.addWidget(self.btn_radial_turn, 2, 0, 1, 1)

        self.btn_turn_ini = QPushButton(self.groupBox_turning)
        self.btn_turn_ini.setObjectName(u"btn_turn_ini")

        self.gridLayout_5.addWidget(self.btn_turn_ini, 0, 0, 1, 1)
        ...
        QWidget.setTabOrder(self.btn_spindle_index, self.btn_lineal_turn)
        ...
        self.menuInvertir.addAction(self.actionInvert_X)
        self.menuInvertir.addAction(self.actionInvert_Y)
        self.menuInvertir.addAction(self.actionInvert_Z)
...
#endif // QT_CONFIG(shortcut)
        self.actionInvert_X.setText(QCoreApplication.translate("MainWindow", u"Dimensi\u00f3n X", None))
#if QT_CONFIG(statustip)
...
#endif // QT_CONFIG(shortcut)
        self.actionInvert_Y.setText(QCoreApplication.translate("MainWindow", u"Dimensi\u00f3n Y", None))
#if QT_CONFIG(statustip)
...
#endif // QT_CONFIG(shortcut)
        self.actionInvert_Z.setText(QCoreApplication.translate("MainWindow", u"Dimensi\u00f3n Z", None))
#if QT_CONFIG(statustip)
