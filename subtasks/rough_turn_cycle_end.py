...
from subtasks.generators.rough_turn_cycle_end_gen import (
    rough_turn_cycle_end_gen,
)


class Rough_turn_cycle_end(QMainWindow):
    def __init__(self, main_window):
        super().__init__()
        self.window = main_window
        self.task = subtasks.tasks_list["Rough_turn_cycle_end"]["Description"]
    ...
    def generator(self, machine: str, data: dict) -> list:
        ...
        return rough_turn_cycle_end_gen(machine, data)
