...
from subtasks.generators.mill_end_gen import mill_end_gen


class Mill_end(QMainWindow):
    def __init__(self, main_window):
        super().__init__()
        self.window = main_window
        self.task = subtasks.tasks_list["Mill_end"]["Description"]
    ...
    def generator(self, machine: str, data: dict) -> list:
        ...
        return mill_end_gen(machine, data)
    ...
    def switcher(self, window: QMainWindow, data: dict):
        ...
        window.btn_mill_end.setEnabled(True)
