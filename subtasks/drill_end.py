...
from subtasks.generators.drill_end_gen import drill_end_gen


class Drill_end(QMainWindow):
    def __init__(self, main_window):
        super().__init__()
        self.window = main_window
        self.task = subtasks.tasks_list["Drill_end"]["Description"]
    ...
    def generator(self, machine: str, data: dict) -> list:
        ...
        return drill_end_gen(machine, data)
    ...
    def switcher(self, window: QMainWindow, data: dict):
        ...
        window.btn_drill_end.setEnabled(False)
