...
################################################################################
## Form generated from reading UI file 'center_drill.ui'
##
...
class Ui_frm_center_drill(object):
    def setupUi(self, frm_center_drill):
        if not frm_center_drill.objectName():
            frm_center_drill.setObjectName(u"frm_center_drill")
        frm_center_drill.resize(210, 580)
        sizePolicy = QSizePolicy(QSizePolicy.Expanding, QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(frm_center_drill.sizePolicy().hasHeightForWidth())
        frm_center_drill.setSizePolicy(sizePolicy)
        frm_center_drill.setMinimumSize(QSize(210, 580))
        frm_center_drill.setMaximumSize(QSize(210, 580))
        icon = QIcon()
        icon.addFile(u":/icons/gear.png", QSize(), QIcon.Normal, QIcon.Off)
        frm_center_drill.setWindowIcon(icon)
        frm_center_drill.setStyleSheet(u"/* ---------------------------------------------------------------------------\n"
"\n"
...
"  padding: 0px;\n"
"}")
        self.centralwidget = QWidget(frm_center_drill)
        ...
        self.tbx_dpt.setObjectName(u"tbx_dpt")
        ...
        self.lbl_dpt.setObjectName(u"lbl_dpt")
        self.lbl_dpt.setEnabled(True)
        self.lbl_dpt.setGeometry(QRect(15, 10, 139, 26))
        self.tbx_dwl = QLineEdit(self.frame)
        self.tbx_dwl.setObjectName(u"tbx_dwl")
        self.tbx_dwl.setGeometry(QRect(10, 330, 170, 26))
        ...
        self.lbl_dwl.setObjectName(u"lbl_dwl")
        self.lbl_dwl.setEnabled(True)
        self.lbl_dwl.setGeometry(QRect(15, 310, 104, 26))
        ...
        self.lbl_fed.setGeometry(QRect(15, 60, 97, 26))
        self.tbx_fed = QLineEdit(self.frame)
        self.tbx_fed.setObjectName(u"tbx_fed")
        self.tbx_fed.setGeometry(QRect(10, 80, 170, 26))
        ...
        self.lbl_sde.setGeometry(QRect(15, 360, 103, 26))
        ...
        self.lbl_zin.setGeometry(QRect(15, 210, 98, 26))
        ...
        self.lbl_sys.setGeometry(QRect(15, 410, 140, 26))
        self.lbl_znd = QLabel(self.frame)
        self.lbl_znd.setObjectName(u"lbl_znd")
        self.lbl_znd.setEnabled(True)
        self.lbl_znd.setGeometry(QRect(15, 460, 105, 26))
        self.cbx_znd = QComboBox(self.frame)
        self.cbx_znd.setObjectName(u"cbx_znd")
        self.cbx_znd.setGeometry(QRect(10, 480, 170, 26))
        self.cbx_znd.setMinimumSize(QSize(170, 26))
        self.cbx_znd.setMaximumSize(QSize(170, 16777215))
        self.tbx_rtr = QLineEdit(self.frame)
        self.tbx_rtr.setObjectName(u"tbx_rtr")
        self.tbx_rtr.setGeometry(QRect(10, 280, 170, 26))
        ...
        self.lbl_rtr.setObjectName(u"lbl_rtr")
        self.lbl_rtr.setEnabled(True)
        self.lbl_rtr.setGeometry(QRect(15, 260, 115, 26))
        self.tbx_dpt.raise_()
        self.lbl_dpt.raise_()
        self.tbx_dwl.raise_()
        self.lbl_dwl.raise_()
        ...
        frm_center_drill.setCentralWidget(self.centralwidget)
#if QT_CONFIG(shortcut)
        self.lbl_dpt.setBuddy(self.lbl_dpt)
        self.lbl_fed.setBuddy(self.lbl_fed)
#endif // QT_CONFIG(shortcut)
        QWidget.setTabOrder(self.tbx_dpt, self.tbx_fed)
        QWidget.setTabOrder(self.tbx_fed, self.tbx_xin)
        ...
        QWidget.setTabOrder(self.tbx_rtr, self.tbx_dwl)
        QWidget.setTabOrder(self.tbx_dwl, self.cbx_sde)
        QWidget.setTabOrder(self.cbx_sde, self.cbx_sys)
        QWidget.setTabOrder(self.cbx_sys, self.cbx_znd)
        QWidget.setTabOrder(self.cbx_znd, self.btn_save)
        QWidget.setTabOrder(self.btn_save, self.btn_help)

        self.retranslateUi(frm_center_drill)

        QMetaObject.connectSlotsByName(frm_center_drill)
    # setupUi

    def retranslateUi(self, frm_center_drill):
        frm_center_drill.setWindowTitle(QCoreApplication.translate("frm_center_drill", u"GCode Editor", None))
#if QT_CONFIG(tooltip)
        self.tbx_dpt.setToolTip(QCoreApplication.translate("frm_center_drill", u"Digite la profundidad del agujero de centro", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
        self.tbx_dpt.setStatusTip("")
#endif // QT_CONFIG(statustip)
        self.tbx_dpt.setPlaceholderText("")
        self.lbl_dpt.setText(QCoreApplication.translate("frm_center_drill", u"Profundidad del agujero", None))
#if QT_CONFIG(tooltip)
        self.tbx_dwl.setToolTip(QCoreApplication.translate("frm_center_drill", u"Digite el tiempo de espera en segundos", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
        self.tbx_dwl.setStatusTip("")
#endif // QT_CONFIG(statustip)
        self.tbx_dwl.setText(QCoreApplication.translate("frm_center_drill", u"0", None))
        self.tbx_dwl.setPlaceholderText("")
        self.lbl_dwl.setText(QCoreApplication.translate("frm_center_drill", u"Tiempo de espera", None))
#if QT_CONFIG(tooltip)
        self.btn_save.setToolTip(QCoreApplication.translate("frm_center_drill", u"Agregar los datos al programa CNC", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
        self.btn_save.setStatusTip("")
#endif // QT_CONFIG(statustip)
        self.btn_save.setText(QCoreApplication.translate("frm_center_drill", u"Agregar", None))
#if QT_CONFIG(shortcut)
        self.btn_save.setShortcut(QCoreApplication.translate("frm_center_drill", u"Ctrl+S", None))
#endif // QT_CONFIG(shortcut)
        self.lbl_fed.setText(QCoreApplication.translate("frm_center_drill", u"Avance de corte", None))
#if QT_CONFIG(tooltip)
        self.tbx_fed.setToolTip(QCoreApplication.translate("frm_center_drill", u"Digite la velocidad de avance de corte", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
...
#if QT_CONFIG(tooltip)
        self.cbx_sde.setToolTip(QCoreApplication.translate("frm_center_drill", u"Seleccione el husillo de trabajo a utilizar", None))
#endif // QT_CONFIG(tooltip)
        self.lbl_sde.setText(QCoreApplication.translate("frm_center_drill", u"Husillo de trabajo", None))
#if QT_CONFIG(tooltip)
        self.tbx_xin.setToolTip(QCoreApplication.translate("frm_center_drill", u"Digite la posici\u00f3n de inicio en el eje X", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
        self.tbx_xin.setStatusTip("")
#endif // QT_CONFIG(statustip)
        self.tbx_xin.setText(QCoreApplication.translate("frm_center_drill", u"0", None))
        self.tbx_xin.setPlaceholderText("")
        self.lbl_xin.setText(QCoreApplication.translate("frm_center_drill", u"Posici\u00f3n inicio X", None))
        self.lbl_yin.setText(QCoreApplication.translate("frm_center_drill", u"Posici\u00f3n inicio Y", None))
#if QT_CONFIG(tooltip)
        self.tbx_yin.setToolTip(QCoreApplication.translate("frm_center_drill", u"Digite la posici\u00f3n de inicio en el eje Y", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
        self.tbx_yin.setStatusTip("")
#endif // QT_CONFIG(statustip)
        self.tbx_yin.setText(QCoreApplication.translate("frm_center_drill", u"0", None))
        self.tbx_yin.setPlaceholderText("")
        self.lbl_zin.setText(QCoreApplication.translate("frm_center_drill", u"Posici\u00f3n inicio Z", None))
#if QT_CONFIG(tooltip)
        self.tbx_zin.setToolTip(QCoreApplication.translate("frm_center_drill", u"Digite la posici\u00f3n de inicio en el eje Z", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
        self.tbx_zin.setStatusTip("")
#endif // QT_CONFIG(statustip)
        self.tbx_zin.setText(QCoreApplication.translate("frm_center_drill", u"0", None))
        self.tbx_zin.setPlaceholderText("")
#if QT_CONFIG(tooltip)
        self.cbx_sys.setToolTip(QCoreApplication.translate("frm_center_drill", u"Seleccione el sistema de coordenadas a utilizar", None))
#endif // QT_CONFIG(tooltip)
        self.lbl_sys.setText(QCoreApplication.translate("frm_center_drill", u"Sistema de coordenadas", None))
        self.lbl_znd.setText(QCoreApplication.translate("frm_center_drill", u"Posici\u00f3n de salida", None))
#if QT_CONFIG(tooltip)
        self.cbx_znd.setToolTip(QCoreApplication.translate("frm_center_drill", u"Seleccione el punto de salida del perforado", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.tbx_rtr.setToolTip(QCoreApplication.translate("frm_center_drill", u"Digite la distancia de retracci\u00f3n", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
        self.tbx_rtr.setStatusTip("")
#endif // QT_CONFIG(statustip)
        self.tbx_rtr.setText(QCoreApplication.translate("frm_center_drill", u"0", None))
        self.tbx_rtr.setPlaceholderText("")
        self.lbl_rtr.setText(QCoreApplication.translate("frm_center_drill", u"Punto de retracci\u00f3n", None))
        self.btn_help.setText("")
#if QT_CONFIG(shortcut)
        self.btn_help.setShortcut(QCoreApplication.translate("frm_center_drill", u"F1", None))
#endif // QT_CONFIG(shortcut)
    # retranslateUi
