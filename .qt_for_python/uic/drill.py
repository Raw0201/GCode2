...
"}")
        ...
        self.lbl_cut.setGeometry(QRect(20, 60, 101, 26))
        ...
        self.lbl_cyl.setGeometry(QRect(20, 610, 91, 26))
    ...
    def retranslateUi(self, frm_drill):
        ...
        self.tbx_dpt.setToolTip(QCoreApplication.translate("frm_drill", u"Digite la profundidad del agujero", None))
...
#if QT_CONFIG(tooltip)
        self.cbx_cyl.setToolTip(QCoreApplication.translate("frm_drill", u"Seleccione si requiere un ciclo de perforado o cortes individuales", None))
#endif // QT_CONFIG(tooltip)
        self.lbl_cyl.setText(QCoreApplication.translate("frm_drill", u"Programaci\u00f3n", None))
#if QT_CONFIG(tooltip)
        self.tbx_ang.setToolTip(QCoreApplication.translate("frm_drill", u"Digite el \u00e1ngulo de la punta de la broca", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
...
#if QT_CONFIG(tooltip)
        self.tbx_dwl.setToolTip(QCoreApplication.translate("frm_drill", u"Digite el tiempo de espera en segundos para pulir el fondo del agujero", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
