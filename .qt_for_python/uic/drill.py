...
################################################################################
## Form generated from reading UI file 'drill.ui'
##
...
class Ui_frm_drill(object):
    def setupUi(self, frm_drill):
        if not frm_drill.objectName():
            frm_drill.setObjectName(u"frm_drill")
        frm_drill.resize(210, 680)
        ...
        frm_drill.setMinimumSize(QSize(210, 680))
        frm_drill.setMaximumSize(QSize(210, 680))
        icon = QIcon()
        icon.addFile(u":/icons/gear.png", QSize(), QIcon.Normal, QIcon.Off)
        frm_drill.setWindowIcon(icon)
        frm_drill.setStyleSheet(u"/* ---------------------------------------------------------------------------\n"
"\n"
...
"}")
        ...
        self.lbl_cut.setGeometry(QRect(20, 60, 105, 26))
        ...
        self.cbx_sde.setGeometry(QRect(10, 430, 170, 26))
        ...
        self.lbl_sde.setGeometry(QRect(20, 410, 101, 26))
        self.tbx_xin = QLineEdit(self.frame)
        self.tbx_xin.setObjectName(u"tbx_xin")
        self.tbx_xin.setGeometry(QRect(10, 230, 170, 26))
        ...
        self.lbl_zin.setGeometry(QRect(20, 310, 98, 26))
        self.tbx_zin = QLineEdit(self.frame)
        self.tbx_zin.setObjectName(u"tbx_zin")
        self.tbx_zin.setGeometry(QRect(10, 330, 170, 26))
        ...
        self.cbx_sys.setGeometry(QRect(10, 480, 170, 26))
        ...
        self.tbx_rtr.setGeometry(QRect(10, 380, 170, 26))
        ...
        self.lbl_rtr.setGeometry(QRect(20, 360, 115, 26))
        self.cbx_cyl = QComboBox(self.frame)
        self.cbx_cyl.setObjectName(u"cbx_cyl")
        self.cbx_cyl.setGeometry(QRect(10, 580, 170, 26))
        self.cbx_cyl.setMinimumSize(QSize(170, 26))
        self.cbx_cyl.setMaximumSize(QSize(170, 16777215))
        self.lbl_cyl = QLabel(self.frame)
        self.lbl_cyl.setObjectName(u"lbl_cyl")
        self.lbl_cyl.setEnabled(True)
        self.lbl_cyl.setGeometry(QRect(20, 560, 105, 26))
    ...
    def retranslateUi(self, frm_drill):
        frm_drill.setWindowTitle(QCoreApplication.translate("frm_drill", u"GCode Editor", None))
#if QT_CONFIG(tooltip)
        self.tbx_dpt.setToolTip(QCoreApplication.translate("frm_drill", u"Digite la profundidad del agujero de centro", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
        self.tbx_dpt.setStatusTip("")
#endif // QT_CONFIG(statustip)
        self.tbx_dpt.setPlaceholderText("")
        self.lbl_dpt.setText(QCoreApplication.translate("frm_drill", u"Profundidad del agujero", None))
#if QT_CONFIG(tooltip)
        self.tbx_cut.setToolTip(QCoreApplication.translate("frm_drill", u"Digite la profundidad de corte por pasada", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
        self.tbx_cut.setStatusTip("")
#endif // QT_CONFIG(statustip)
        self.tbx_cut.setText("")
        self.tbx_cut.setPlaceholderText("")
        self.lbl_cut.setText(QCoreApplication.translate("frm_drill", u"Corte por pasada", None))
#if QT_CONFIG(tooltip)
        self.btn_save.setToolTip(QCoreApplication.translate("frm_drill", u"Agregar los datos al programa CNC", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
        self.btn_save.setStatusTip("")
#endif // QT_CONFIG(statustip)
        self.btn_save.setText(QCoreApplication.translate("frm_drill", u"Agregar", None))
#if QT_CONFIG(shortcut)
        self.btn_save.setShortcut(QCoreApplication.translate("frm_drill", u"Ctrl+S", None))
#endif // QT_CONFIG(shortcut)
        self.lbl_fed.setText(QCoreApplication.translate("frm_drill", u"Avance de corte", None))
#if QT_CONFIG(tooltip)
        self.tbx_fed.setToolTip(QCoreApplication.translate("frm_drill", u"Digite la velocidad de avance de corte", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
...
#if QT_CONFIG(tooltip)
        self.cbx_sde.setToolTip(QCoreApplication.translate("frm_drill", u"Seleccione el husillo de trabajo a utilizar", None))
#endif // QT_CONFIG(tooltip)
        self.lbl_sde.setText(QCoreApplication.translate("frm_drill", u"Husillo de trabajo", None))
#if QT_CONFIG(tooltip)
        self.tbx_xin.setToolTip(QCoreApplication.translate("frm_drill", u"Digite la posici\u00f3n de inicio en el eje X", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
...
#if QT_CONFIG(tooltip)
        self.tbx_yin.setToolTip(QCoreApplication.translate("frm_drill", u"Digite la posici\u00f3n de inicio en el eje Y", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
...
#if QT_CONFIG(tooltip)
        self.tbx_zin.setToolTip(QCoreApplication.translate("frm_drill", u"Digite la posici\u00f3n de inicio en el eje Z", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
...
#endif // QT_CONFIG(tooltip)
        self.lbl_sys.setText(QCoreApplication.translate("frm_drill", u"Sistema de coordenadas", None))
        self.lbl_znd.setText(QCoreApplication.translate("frm_drill", u"Posici\u00f3n de salida", None))
#if QT_CONFIG(tooltip)
        self.cbx_znd.setToolTip(QCoreApplication.translate("frm_drill", u"Seleccione el punto de salida del perforado", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.tbx_rtr.setToolTip(QCoreApplication.translate("frm_drill", u"Digite la distancia de retracci\u00f3n", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
...
#if QT_CONFIG(tooltip)
        self.cbx_cyl.setToolTip(QCoreApplication.translate("frm_drill", u"Seleccione si desea un ciclo de perforado o cortes individuales", None))
#endif // QT_CONFIG(tooltip)
        self.lbl_cyl.setText(QCoreApplication.translate("frm_drill", u"Programaci\u00f3n", None))
#if QT_CONFIG(tooltip)
        self.tbx_ang.setToolTip(QCoreApplication.translate("frm_drill", u"Digite la profundidad de corte por pasada", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
...
#if QT_CONFIG(shortcut)
        self.btn_help.setShortcut(QCoreApplication.translate("frm_drill", u"F1", None))
#endif // QT_CONFIG(shortcut)
    # retranslateUi
