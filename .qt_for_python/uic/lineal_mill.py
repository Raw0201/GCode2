...
################################################################################
## Form generated from reading UI file 'lineal_mill.ui'
##
...
class Ui_frm_lineal_mill(object):
    def setupUi(self, frm_lineal_mill):
        if not frm_lineal_mill.objectName():
            frm_lineal_mill.setObjectName(u"frm_lineal_mill")
        frm_lineal_mill.resize(210, 530)
        sizePolicy = QSizePolicy(QSizePolicy.Expanding, QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(frm_lineal_mill.sizePolicy().hasHeightForWidth())
        frm_lineal_mill.setSizePolicy(sizePolicy)
        frm_lineal_mill.setMinimumSize(QSize(210, 530))
        frm_lineal_mill.setMaximumSize(QSize(210, 530))
        icon = QIcon()
        icon.addFile(u":/icons/gear.png", QSize(), QIcon.Normal, QIcon.Off)
        frm_lineal_mill.setWindowIcon(icon)
        frm_lineal_mill.setStyleSheet(u"/* ---------------------------------------------------------------------------\n"
"\n"
...
"  padding: 0px;\n"
"}")
        self.centralwidget = QWidget(frm_lineal_mill)
        ...
        self.lbl_xin.setGeometry(QRect(15, 10, 103, 26))
        ...
        self.lbl_mov.setGeometry(QRect(15, 260, 117, 26))
        self.cbx_mov = QComboBox(self.frame)
        self.cbx_mov.setObjectName(u"cbx_mov")
        self.cbx_mov.setGeometry(QRect(10, 280, 170, 26))
        ...
        self.lbl_zin.setGeometry(QRect(15, 110, 103, 26))
        ...
        self.btn_switch.setGeometry(QRect(10, 480, 171, 24))
        ...
        self.lbl_yin.setGeometry(QRect(15, 60, 103, 26))
        self.cbx_sys = QComboBox(self.frame)
        self.cbx_sys.setObjectName(u"cbx_sys")
        self.cbx_sys.setGeometry(QRect(10, 330, 170, 26))
        ...
        self.lbl_sys.setGeometry(QRect(15, 310, 139, 26))
        self.cbx_com = QComboBox(self.frame)
        self.cbx_com.setObjectName(u"cbx_com")
        self.cbx_com.setGeometry(QRect(10, 380, 170, 26))
        self.cbx_com.setMinimumSize(QSize(170, 26))
        self.cbx_com.setMaximumSize(QSize(170, 16777215))
        self.lbl_com = QLabel(self.frame)
        self.lbl_com.setObjectName(u"lbl_com")
        self.lbl_com.setEnabled(True)
        self.lbl_com.setGeometry(QRect(15, 360, 127, 26))
        self.lbl_rep = QLabel(self.frame)
        self.lbl_rep.setObjectName(u"lbl_rep")
        self.lbl_rep.setEnabled(True)
        self.lbl_rep.setGeometry(QRect(15, 210, 142, 26))
        self.tbx_rep = QLineEdit(self.frame)
        self.tbx_rep.setObjectName(u"tbx_rep")
        self.tbx_rep.setGeometry(QRect(10, 230, 170, 26))
        ...
        frm_lineal_mill.setCentralWidget(self.centralwidget)
#if QT_CONFIG(shortcut)
        self.lbl_xin.setBuddy(self.lbl_xin)
        self.lbl_mov.setBuddy(self.lbl_mov)
        self.lbl_zin.setBuddy(self.lbl_xin)
        self.lbl_fed.setBuddy(self.lbl_xin)
        self.lbl_yin.setBuddy(self.lbl_xin)
        self.lbl_sys.setBuddy(self.lbl_mov)
        self.lbl_com.setBuddy(self.lbl_mov)
        self.lbl_rep.setBuddy(self.lbl_mov)
        ...
        QWidget.setTabOrder(self.tbx_fed, self.tbx_rep)
        QWidget.setTabOrder(self.tbx_rep, self.cbx_mov)
        QWidget.setTabOrder(self.cbx_mov, self.cbx_sys)
        QWidget.setTabOrder(self.cbx_sys, self.cbx_com)
        QWidget.setTabOrder(self.cbx_com, self.btn_save)
        QWidget.setTabOrder(self.btn_save, self.btn_switch)
        QWidget.setTabOrder(self.btn_switch, self.btn_help)

        self.retranslateUi(frm_lineal_mill)

        QMetaObject.connectSlotsByName(frm_lineal_mill)
    # setupUi

    def retranslateUi(self, frm_lineal_mill):
        frm_lineal_mill.setWindowTitle(QCoreApplication.translate("frm_lineal_mill", u"GCode Editor", None))
#if QT_CONFIG(tooltip)
        self.tbx_xin.setToolTip(QCoreApplication.translate("frm_lineal_mill", u"Digite la dimensi\u00f3n del movimiento en el eje X", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
        self.tbx_xin.setStatusTip("")
#endif // QT_CONFIG(statustip)
        self.tbx_xin.setPlaceholderText("")
        self.lbl_xin.setText(QCoreApplication.translate("frm_lineal_mill", u"Movimiento eje X", None))
#if QT_CONFIG(tooltip)
        self.btn_save.setToolTip(QCoreApplication.translate("frm_lineal_mill", u"Agregar los datos al programa CNC", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
        self.btn_save.setStatusTip("")
#endif // QT_CONFIG(statustip)
        self.btn_save.setText(QCoreApplication.translate("frm_lineal_mill", u"Agregar", None))
#if QT_CONFIG(shortcut)
        self.btn_save.setShortcut(QCoreApplication.translate("frm_lineal_mill", u"Ctrl+S", None))
#endif // QT_CONFIG(shortcut)
        self.lbl_mov.setText(QCoreApplication.translate("frm_lineal_mill", u"Tipo de movimiento", None))
#if QT_CONFIG(tooltip)
        self.cbx_mov.setToolTip(QCoreApplication.translate("frm_lineal_mill", u"Seleccione el tipo de movimiento a ejecutar", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.tbx_zin.setToolTip(QCoreApplication.translate("frm_lineal_mill", u"Digite la dimensi\u00f3n del movimiento en el eje Z", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
        self.tbx_zin.setStatusTip("")
#endif // QT_CONFIG(statustip)
        self.tbx_zin.setPlaceholderText("")
        self.lbl_zin.setText(QCoreApplication.translate("frm_lineal_mill", u"Movimiento eje Z", None))
#if QT_CONFIG(tooltip)
        self.tbx_fed.setToolTip(QCoreApplication.translate("frm_lineal_mill", u"Digite la velocidad de avance de corte", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
        self.tbx_fed.setStatusTip("")
#endif // QT_CONFIG(statustip)
        self.tbx_fed.setPlaceholderText("")
        self.lbl_fed.setText(QCoreApplication.translate("frm_lineal_mill", u"Avance de corte", None))
#if QT_CONFIG(tooltip)
        self.btn_switch.setToolTip(QCoreApplication.translate("frm_lineal_mill", u"Cambia a la funci\u00f3n indicada", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
        self.btn_switch.setStatusTip("")
#endif // QT_CONFIG(statustip)
        self.btn_switch.setText(QCoreApplication.translate("frm_lineal_mill", u"Cambiar a Fresado radial", None))
#if QT_CONFIG(shortcut)
        self.btn_switch.setShortcut(QCoreApplication.translate("frm_lineal_mill", u"Ctrl+Q", None))
#endif // QT_CONFIG(shortcut)
#if QT_CONFIG(tooltip)
        self.tbx_yin.setToolTip(QCoreApplication.translate("frm_lineal_mill", u"Digite la dimensi\u00f3n del movimiento en el eje Y", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
        self.tbx_yin.setStatusTip("")
#endif // QT_CONFIG(statustip)
        self.tbx_yin.setPlaceholderText("")
        self.lbl_yin.setText(QCoreApplication.translate("frm_lineal_mill", u"Movimiento eje Y", None))
#if QT_CONFIG(tooltip)
        self.cbx_sys.setToolTip(QCoreApplication.translate("frm_lineal_mill", u"Seleccione el sistema de coordenadas a utilizar", None))
#endif // QT_CONFIG(tooltip)
        self.lbl_sys.setText(QCoreApplication.translate("frm_lineal_mill", u"Sistema de coordenadas", None))
#if QT_CONFIG(tooltip)
        self.cbx_com.setToolTip(QCoreApplication.translate("frm_lineal_mill", u"Seleccione el sentido de la compensaci\u00f3n de herramienta", None))
#endif // QT_CONFIG(tooltip)
        self.lbl_com.setText(QCoreApplication.translate("frm_lineal_mill", u"Compensaci\u00f3n de hta", None))
        self.lbl_rep.setText(QCoreApplication.translate("frm_lineal_mill", u"Cantidad de repeticiones", None))
#if QT_CONFIG(tooltip)
        self.tbx_rep.setToolTip(QCoreApplication.translate("frm_lineal_mill", u"Digite la cantidad de repeticiones", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
...
#if QT_CONFIG(shortcut)
        self.btn_help.setShortcut(QCoreApplication.translate("frm_lineal_mill", u"F1", None))
#endif // QT_CONFIG(shortcut)
    # retranslateUi
