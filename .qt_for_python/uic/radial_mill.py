...
class Ui_frm_radial_mill(object):
    def setupUi(self, frm_radial_mill):
        ...
        frm_radial_mill.resize(210, 480)
        ...
        frm_radial_mill.setMinimumSize(QSize(210, 480))
        frm_radial_mill.setMaximumSize(QSize(210, 480))
        icon = QIcon()
...
"}")
        ...
        self.tbx_rad = QLineEdit(self.frame)
        self.tbx_rad.setObjectName(u"tbx_rad")
        self.tbx_rad.setGeometry(QRect(10, 230, 170, 26))
        self.tbx_rad.setMinimumSize(QSize(170, 0))
        self.tbx_rad.setMaximumSize(QSize(170, 16777215))
        self.tbx_rad.setAlignment(Qt.AlignCenter)
        self.lbl_rad = QLabel(self.frame)
        self.lbl_rad.setObjectName(u"lbl_rad")
        self.lbl_rad.setEnabled(True)
        self.lbl_rad.setGeometry(QRect(20, 210, 118, 26))
        ...
        self.lbl_sys.setGeometry(QRect(20, 310, 141, 26))
        self.tbx_xin.raise_()
        self.lbl_xin.raise_()
        ...
        self.lbl_rad.setBuddy(self.lbl_xin)
        ...
        QWidget.setTabOrder(self.tbx_fed, self.tbx_rad)
        QWidget.setTabOrder(self.tbx_rad, self.cbx_rot)
...
#endif // QT_CONFIG(shortcut)
#if QT_CONFIG(tooltip)
        self.tbx_rad.setToolTip(QCoreApplication.translate("frm_radial_mill", u"Digite la dimensi\u00f3n del radio", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
        self.tbx_rad.setStatusTip("")
#endif // QT_CONFIG(statustip)
        self.tbx_rad.setPlaceholderText("")
        self.lbl_rad.setText(QCoreApplication.translate("frm_radial_mill", u"Dimensi\u00f3n del radio", None))
#if QT_CONFIG(tooltip)
