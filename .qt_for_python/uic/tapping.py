...
################################################################################
## Form generated from reading UI file 'tapping.ui'
##
...
class Ui_frm_tapping(object):
    def setupUi(self, frm_tapping):
        if not frm_tapping.objectName():
            frm_tapping.setObjectName(u"frm_tapping")
        frm_tapping.resize(210, 530)
        sizePolicy = QSizePolicy(QSizePolicy.Expanding, QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(frm_tapping.sizePolicy().hasHeightForWidth())
        frm_tapping.setSizePolicy(sizePolicy)
        frm_tapping.setMinimumSize(QSize(210, 530))
        frm_tapping.setMaximumSize(QSize(210, 530))
        icon = QIcon()
        icon.addFile(u":/icons/gear.png", QSize(), QIcon.Normal, QIcon.Off)
        frm_tapping.setWindowIcon(icon)
        frm_tapping.setStyleSheet(u"/* ---------------------------------------------------------------------------\n"
"\n"
...
"  padding: 0px;\n"
"}")
        self.centralwidget = QWidget(frm_tapping)
        ...
        self.lbl_dpt.setGeometry(QRect(15, 10, 137, 26))
        ...
        self.cbx_sde.setGeometry(QRect(10, 330, 170, 26))
        ...
        self.lbl_sde.setGeometry(QRect(15, 310, 103, 26))
        ...
        self.cbx_sys.setGeometry(QRect(10, 380, 170, 26))
        ...
        self.cbx_thd = QComboBox(self.frame)
        self.cbx_thd.setObjectName(u"cbx_thd")
        self.cbx_thd.setGeometry(QRect(10, 80, 170, 26))
        self.cbx_thd.setMinimumSize(QSize(170, 26))
        self.cbx_thd.setMaximumSize(QSize(170, 16777215))
        self.lbl_thd = QLabel(self.frame)
        self.lbl_thd.setObjectName(u"lbl_thd")
        self.lbl_thd.setEnabled(True)
        self.lbl_thd.setGeometry(QRect(15, 60, 127, 26))
        self.tbx_dpt.raise_()
        self.lbl_dpt.raise_()
        ...
        frm_tapping.setCentralWidget(self.centralwidget)
#if QT_CONFIG(shortcut)
        self.lbl_dpt.setBuddy(self.lbl_dpt)
#endif // QT_CONFIG(shortcut)
        QWidget.setTabOrder(self.tbx_dpt, self.cbx_thd)
        QWidget.setTabOrder(self.cbx_thd, self.tbx_xin)
        ...
        self.retranslateUi(frm_tapping)

        QMetaObject.connectSlotsByName(frm_tapping)
    # setupUi

    def retranslateUi(self, frm_tapping):
        frm_tapping.setWindowTitle(QCoreApplication.translate("frm_tapping", u"GCode Editor", None))
#if QT_CONFIG(tooltip)
        self.tbx_dpt.setToolTip(QCoreApplication.translate("frm_tapping", u"Digite la profundidad del agujero", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
        self.tbx_dpt.setStatusTip("")
#endif // QT_CONFIG(statustip)
        self.tbx_dpt.setPlaceholderText("")
        self.lbl_dpt.setText(QCoreApplication.translate("frm_tapping", u"Profundidad de la rosca", None))
#if QT_CONFIG(tooltip)
        self.btn_save.setToolTip(QCoreApplication.translate("frm_tapping", u"Agregar los datos al programa CNC", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
        self.btn_save.setStatusTip("")
#endif // QT_CONFIG(statustip)
        self.btn_save.setText(QCoreApplication.translate("frm_tapping", u"Agregar", None))
#if QT_CONFIG(shortcut)
        self.btn_save.setShortcut(QCoreApplication.translate("frm_tapping", u"Ctrl+S", None))
#endif // QT_CONFIG(shortcut)
#if QT_CONFIG(tooltip)
        self.cbx_sde.setToolTip(QCoreApplication.translate("frm_tapping", u"Seleccione el husillo de trabajo a utilizar", None))
#endif // QT_CONFIG(tooltip)
        self.lbl_sde.setText(QCoreApplication.translate("frm_tapping", u"Husillo de trabajo", None))
#if QT_CONFIG(tooltip)
        self.tbx_xin.setToolTip(QCoreApplication.translate("frm_tapping", u"Digite la posici\u00f3n de inicio en el eje X", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
        self.tbx_xin.setStatusTip("")
#endif // QT_CONFIG(statustip)
        self.tbx_xin.setText(QCoreApplication.translate("frm_tapping", u"0", None))
        self.tbx_xin.setPlaceholderText("")
        self.lbl_xin.setText(QCoreApplication.translate("frm_tapping", u"Posici\u00f3n inicio X", None))
        self.lbl_yin.setText(QCoreApplication.translate("frm_tapping", u"Posici\u00f3n inicio Y", None))
#if QT_CONFIG(tooltip)
        self.tbx_yin.setToolTip(QCoreApplication.translate("frm_tapping", u"Digite la posici\u00f3n de inicio en el eje Y", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
        self.tbx_yin.setStatusTip("")
#endif // QT_CONFIG(statustip)
        self.tbx_yin.setText(QCoreApplication.translate("frm_tapping", u"0", None))
        self.tbx_yin.setPlaceholderText("")
        self.lbl_zin.setText(QCoreApplication.translate("frm_tapping", u"Posici\u00f3n inicio Z", None))
#if QT_CONFIG(tooltip)
        self.tbx_zin.setToolTip(QCoreApplication.translate("frm_tapping", u"Digite la posici\u00f3n de inicio en el eje Z", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
        self.tbx_zin.setStatusTip("")
#endif // QT_CONFIG(statustip)
        self.tbx_zin.setText(QCoreApplication.translate("frm_tapping", u"0", None))
        self.tbx_zin.setPlaceholderText("")
#if QT_CONFIG(tooltip)
        self.cbx_sys.setToolTip(QCoreApplication.translate("frm_tapping", u"Seleccione el sistema de coordenadas a utilizar", None))
#endif // QT_CONFIG(tooltip)
        self.lbl_sys.setText(QCoreApplication.translate("frm_tapping", u"Sistema de coordenadas", None))
        self.lbl_znd.setText(QCoreApplication.translate("frm_tapping", u"Posici\u00f3n de salida", None))
#if QT_CONFIG(tooltip)
        self.cbx_znd.setToolTip(QCoreApplication.translate("frm_tapping", u"Seleccione el punto de salida del perforado", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.tbx_rtr.setToolTip(QCoreApplication.translate("frm_tapping", u"Digite la distancia de retracci\u00f3n", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
        self.tbx_rtr.setStatusTip("")
#endif // QT_CONFIG(statustip)
        self.tbx_rtr.setText(QCoreApplication.translate("frm_tapping", u"0", None))
        self.tbx_rtr.setPlaceholderText("")
        self.lbl_rtr.setText(QCoreApplication.translate("frm_tapping", u"Punto de retracci\u00f3n", None))
#if QT_CONFIG(tooltip)
        self.cbx_thd.setToolTip(QCoreApplication.translate("frm_tapping", u"Seleccione la dimensi\u00f3n de la rosca", None))
#endif // QT_CONFIG(tooltip)
        self.lbl_thd.setText(QCoreApplication.translate("frm_tapping", u"Dimensi\u00f3n de la rosca", None))
        self.btn_help.setText("")
#if QT_CONFIG(shortcut)
        self.btn_help.setShortcut(QCoreApplication.translate("frm_tapping", u"F1", None))
#endif // QT_CONFIG(shortcut)
    # retranslateUi
